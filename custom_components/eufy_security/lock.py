...
class EufySecurityLock(EufySecurityEntity, LockEntity):
    ...
    async def _wait_for_lock_state(self, target: bool) -> None:
    ...
    async def _set_locked(self, value: bool) -> None:
        ...
        async with self.coordinator.lock_command_lock(serial):
            ...
            try:
                ...
                await self._wait_for_lock_state(value)
